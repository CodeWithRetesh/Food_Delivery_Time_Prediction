...
├── app/
│   └── app.py
│       # Main application file (model loading & prediction logic)
│
├── dataset/
...
│   ├── model.pkl
│   └── preprocessor.pkl
│       # Trained ML models and preprocessing pipeline
│
├── notebook/
...
Writing clean and structured project code
